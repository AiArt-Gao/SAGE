...
def rgb_feat_parsing_integration(rgb_sigma, parsing, feats, z_vals, device, noise_std=0.5, last_back=False, white_back=False, clamp_mode=None, fill_mode=None):
    ...
    parsing_final = torch.sum(weights * parsing, -2)
    ...
    return rgb_final, feat_final, depth_final, parsing_final


def rgb_feat_integration(rgb_sigma, feats, z_vals, device, noise_std=0.5, last_back=False, white_back=False, clamp_mode=None, fill_mode=None):
    """Performs NeRF volumetric rendering."""
    ...
    return rgb_final, feat_final, depth_final
