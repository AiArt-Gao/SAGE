...
CelebA = {
    0: {'batch_size': 32, 'num_steps': 16, 'img_size': 64, 'output_size': 64, 'batch_split': 4, 'gen_lr': 6e-5, 'disc_lr': 2e-4, 'pos_lambda': 15, 'reproj_lambda': 1},
    int(25e3): {'batch_size': 24, 'num_steps': 16, 'img_size': 64, 'output_size': 128, 'batch_split': 4, 'gen_lr': 5e-5, 'disc_lr': 2e-4, 'pos_lambda': 15, 'reproj_lambda': 1},
    int(50e3): {'batch_size': 24, 'num_steps': 16, 'img_size': 64, 'output_size': 256, 'batch_split': 4, 'gen_lr': 3e-5, 'disc_lr': 1e-4, 'pos_lambda': 0, 'reproj_lambda': 1},
    int(90e3): {},
    # if you use your own dataset, please change the image_path and parsing_path
    'image_path': '/data/jiangchang/CelebAMask-HQ/CelebA-HQ-img/*.jpg',
